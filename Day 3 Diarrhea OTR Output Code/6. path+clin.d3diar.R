...
# Treatment effects for the Pathogens and Symptoms code for DAY 3 DIARRHEA outcome
#
#
# Sara Kim
# 28 January 2024
...
results_diar_pc150 <- estimate_OTR(df = abcd_data,
                                   Y_name = "day3diar",
                                   A_name = "an_grp_01",
                                   W_list = W_list,
                                   Z_list = Z_lists,
...
saveRDS(results_diar_pc150$results, "results_diar_pc150.RData")
saveRDS(results_diar_pc150$CATE_models, "catemodels_diar_pc150.RData")
...
results_diar_pc300 <- estimate_OTR(df = abcd_data,
                                   Y_name = "day3diar",
                                   A_name = "an_grp_01",
                                   W_list = W_list,
                                   Z_list = Z_lists,
...
saveRDS(results_diar_pc300$results, "results_diar_pc300.RData")
saveRDS(results_diar_pc300$CATE_models, "catemodels_diar_pc300.RData")
...
results_diar_pc450 <- estimate_OTR(df = abcd_data,
                                   Y_name = "day3diar",
                                   A_name = "an_grp_01",
                                   W_list = W_list,
                                   Z_list = Z_lists,
...
saveRDS(results_diar_pc450$results, "results_diar_pc450.RData")
saveRDS(results_diar_pc450$CATE_models, "catemodels_diar_pc450.RData")
...
results_diar_pc600 <- estimate_OTR(df = abcd_data,
                                   Y_name = "day3diar",
                                   A_name = "an_grp_01",
                                   W_list = W_list,
                                   Z_list = Z_lists,
...
saveRDS(results_diar_pc600$results, "results_diar_pc600.RData")
saveRDS(results_diar_pc600$CATE_models, "catemodels_diar_pc600.RData")
...
results_diar_pc750 <- estimate_OTR(df = abcd_data,
                                   Y_name = "day3diar",
                                   A_name = "an_grp_01",
                                   W_list = W_list,
                                   Z_list = Z_lists,
...
saveRDS(results_diar_pc750$results, "results_diar_pc750.RData")
saveRDS(results_diar_pc750$CATE_models, "catemodels_diar_pc750.RData")
