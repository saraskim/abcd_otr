...
# Treatment effects for the Clinical Symptoms code for DAY 3 DIARRHEA outcome
#
#
# Sara Kim
# 28 January 2024
...
results_diar_clin150 <- estimate_OTR(df = abcd_data,
                                       Y_name = "day3diar",
                                       A_name = "an_grp_01",
                                       W_list = W_list,
                                       Z_list = Z_lists,
...
saveRDS(results_diar_clin150$results, "results_diar_clin150.RData")
saveRDS(results_diar_clin150$CATE_models, "catemodels_diar_clin150.RData")
...
results_diar_clin300 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_clin300$results, "results_diar_clin300.RData")
saveRDS(results_diar_clin300$CATE_models, "catemodels_diar_clin300.RData")
...
results_diar_clin450 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_clin450$results, "results_diar_clin450.RData")
saveRDS(results_diar_clin450$CATE_models, "catemodels_diar_clin450.RData")
...
results_diar_clin600 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_clin600$results, "results_diar_clin600.RData")
saveRDS(results_diar_clin600$CATE_models, "catemodels_diar_clin600.RData")
...
results_diar_clin750 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_clin750$results, "results_diar_clin750.RData")
saveRDS(results_diar_clin750$CATE_models, "catemodels_diar_clin750.RData")
