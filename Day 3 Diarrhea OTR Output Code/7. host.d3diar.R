...
# Treatment effects for the host (malnutrition + sociodemographics) rule code for DAY 3 DIARRHEA outcome
#
#
# Sara Kim
# 28 January 2024
...
results_diar_mal150 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_mal150$results, "results_diar_mal150.RData")
saveRDS(results_diar_mal150$CATE_models, "catemodels_diar_mal150.RData")
...
results_diar_mal300 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_mal300$results, "results_diar_mal300.RData")
saveRDS(results_diar_mal300$CATE_models, "catemodels_diar_mal300.RData")
...
results_diar_mal450 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_mal450$results, "results_diar_mal450.RData")
saveRDS(results_diar_mal450$CATE_models, "catemodels_diar_mal450.RData")
...
results_diar_mal600 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_mal600$results, "results_diar_mal600.RData")
saveRDS(results_diar_mal600$CATE_models, "catemodels_diar_mal600.RData")
...
results_diar_mal750 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_mal750$results, "results_diar_mal750.RData")
saveRDS(results_diar_mal750$CATE_models, "catemodels_diar_mal750.RData")
