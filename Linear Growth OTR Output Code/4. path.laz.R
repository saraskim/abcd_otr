...
# Treatment effects for the PATHOGEN QUANTITIES RULE code for linear growth outcome
#
#
# Sara Kim
# 28 January 2024
...
results_laz_path150 <- estimate_OTR(df = abcd_data,
                                       Y_name = "lazdiff",
                                       A_name = "an_grp_01",
                                       W_list = W_list,
                                       Z_list = Z_lists,
...
saveRDS(results_laz_path150$results, "results_laz_path150.RData")
saveRDS(results_laz_path150$CATE_models, "catemodels_laz_path150.RData")
...
results_laz_path300 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_path300$results, "results_laz_path300.RData")
saveRDS(results_laz_path300$CATE_models, "catemodels_laz_path300.RData")
...
results_laz_path450 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_path450$results, "results_laz_path450.RData")
saveRDS(results_laz_path450$CATE_models, "catemodels_laz_path450.RData")
...
results_laz_path600 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_path600$results, "results_laz_path600.RData")
saveRDS(results_laz_path600$CATE_models, "catemodels_laz_path600.RData")
...
results_laz_path750 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_path750$results, "results_laz_path750.RData")
saveRDS(results_laz_path750$CATE_models, "catemodels_laz_path750.RData")
