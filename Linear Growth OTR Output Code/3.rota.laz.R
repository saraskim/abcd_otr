...
# Treatment effects for the ROTAVIRUS RULE code for linear growth outcome
#
#
# Sara Kim
# 28 January 2024
...
results_laz_rota150 <- estimate_OTR(df = abcd_data,
                                       Y_name = "lazdiff",
                                       A_name = "an_grp_01",
                                       W_list = W_list,
                                       Z_list = Z_lists,
...
saveRDS(results_laz_rota150$results, "results_laz_rota150.RData")
saveRDS(results_laz_rota150$CATE_models, "catemodels_laz_rota150.RData")
...
results_laz_rota300 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_rota300$results, "results_laz_rota300.RData")
saveRDS(results_laz_rota300$CATE_models, "catemodels_laz_rota300.RData")
...
results_laz_rota450 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_rota450$results, "results_laz_rota450.RData")
saveRDS(results_laz_rota450$CATE_models, "catemodels_laz_rota450.RData")
...
results_laz_rota600 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_rota600$results, "results_laz_rota600.RData")
saveRDS(results_laz_rota600$CATE_models, "catemodels_laz_rota600.RData")
...
results_laz_rota750 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_rota750$results, "results_laz_rota750.RData")
saveRDS(results_laz_rota750$CATE_models, "catemodels_laz_rota750.RData")
