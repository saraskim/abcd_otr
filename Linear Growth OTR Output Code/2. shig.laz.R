...
# Treatment effects for the SHIGELLA RULE code for linear growth outcome
#
#
# Sara Kim
# 28 January 2024
...
results_laz_shig150 <- estimate_OTR(df = abcd_data,
                                       Y_name = "lazdiff",
                                       A_name = "an_grp_01",
                                       W_list = W_list,
                                       Z_list = Z_lists,
...
saveRDS(results_laz_shig150$results, "results_laz_shig150.RData")
saveRDS(results_laz_shig150$CATE_models, "catemodels_laz_shig150.RData")
...
results_laz_shig300 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_shig300$results, "results_laz_shig300.RData")
saveRDS(results_laz_shig300$CATE_models, "catemodels_laz_shig300.RData")
...
results_laz_shig450 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_shig450$results, "results_laz_shig450.RData")
saveRDS(results_laz_shig450$CATE_models, "catemodels_laz_shig450.RData")
...
results_laz_shig600 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_shig600$results, "results_laz_shig600.RData")
saveRDS(results_laz_shig600$CATE_models, "catemodels_laz_shig600.RData")
...
results_laz_shig750 <- estimate_OTR(df = abcd_data,
                                    Y_name = "lazdiff",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_laz_shig750$results, "results_laz_shig750.RData")
saveRDS(results_laz_shig750$CATE_models, "catemodels_laz_shig750.RData")
