...
# Treatment effects for the Clinical Symptoms code for DAY 90 REHOSPITALIZATION OR DEATH outcome
#
#
# Sara Kim
# 28 January 2024
...
results_hosp_clin150 <- estimate_OTR(df = abcd_data,
...
saveRDS(results_hosp_clin150$results, "results_hosp_clin150.RData")
saveRDS(results_hosp_clin150$CATE_models, "catemodels_hosp_clin150.RData")
...
results_hosp_clin300 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_clin300$results, "results_hosp_clin300.RData")
saveRDS(results_hosp_clin300$CATE_models, "catemodels_hosp_clin300.RData")
...
results_hosp_clin450 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_clin450$results, "results_hosp_clin450.RData")
saveRDS(results_hosp_clin450$CATE_models, "catemodels_hosp_clin450.RData")
...
results_hosp_clin600 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_clin600$results, "results_hosp_clin600.RData")
saveRDS(results_hosp_clin600$CATE_models, "catemodels_hosp_clin600.RData")
...
results_hosp_clin750 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_clin750$results, "results_hosp_clin750.RData")
saveRDS(results_hosp_clin750$CATE_models, "catemodels_hosp_clin750.RData")
