...
# Treatment effects for the symptoms + host (ie. no pathogen) rule code for DAY 90 REHOSPITALIZATION OR DEATH outcome
#
#
# Sara Kim
# 28 January 2024
...
results_hosp_nop150 <- estimate_OTR(df = abcd_data,
...
saveRDS(results_hosp_nop150$results, "results_hosp_nop150.RData")
saveRDS(results_hosp_nop150$CATE_models, "catemodels_hosp_nop150.RData")
...
results_hosp_nop300 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_nop300$results, "results_hosp_nop300.RData")
saveRDS(results_hosp_nop300$CATE_models, "catemodels_hosp_nop300.RData")
...
results_hosp_nop450 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_nop450$results, "results_hosp_nop450.RData")
saveRDS(results_hosp_nop450$CATE_models, "catemodels_hosp_nop450.RData")
...
results_hosp_nop600 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_nop600$results, "results_hosp_nop600.RData")
saveRDS(results_hosp_nop600$CATE_models, "catemodels_hosp_nop600.RData")
...
results_hosp_nop750 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_nop750$results, "results_hosp_nop750.RData")
saveRDS(results_hosp_nop750$CATE_models, "catemodels_hosp_nop750.RData")
