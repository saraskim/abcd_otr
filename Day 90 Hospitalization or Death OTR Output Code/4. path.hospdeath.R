...
# Treatment effects for the PATHOGEN QUANTITIES RULE code for DAY 90 REHOSPITALIZATION OR DEATH outcome
#
#
# Sara Kim
# 28 January 2024
...
# ----- Define CATE models to estimate child level expected benefit for the Pathogen Quantities rule
# --- Include "nested" models (Shigella rule, Rotavirus rule) that contain variables in the Pathogen Quantities rule 
...
# ------ Define variables in the Pathogen Quantities rule 
...
results_hosp_path150 <- estimate_OTR(df = abcd_data,
...
saveRDS(results_hosp_path150$results, "results_hosp_path150.RData")
saveRDS(results_hosp_path150$CATE_models, "catemodels_hosp_path150.RData")
...
results_hosp_path300 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_path300$results, "results_hosp_path300.RData")
saveRDS(results_hosp_path300$CATE_models, "catemodels_hosp_path300.RData")
...
results_hosp_path450 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_path450$results, "results_hosp_path450.RData")
saveRDS(results_hosp_path450$CATE_models, "catemodels_hosp_path450.RData")
...
results_hosp_path600 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_path600$results, "results_hosp_path600.RData")
saveRDS(results_hosp_path600$CATE_models, "catemodels_hosp_path600.RData")

# seed 750
nuisance_output <- readRDS("nuisance750_hospdeath_24apr2024.RData")
nuisance_models <- nuisance_output$nuisance_models
k_fold_assign_and_CATE <- nuisance_output$k_fold_assign_and_CATE
validRows <- nuisance_output$validRows
...
results_hosp_path750 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_path750$results, "results_hosp_path750.RData")
saveRDS(results_hosp_path750$CATE_models, "catemodels_hosp_path750.RData")
