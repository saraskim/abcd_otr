...
# Treatment effects for the comprehensive rule code for DAY 90 REHOSPITALIZATION OR DEATH outcome
#
#
# Sara Kim
# 28 January 2024
...
results_hosp_all150 <- estimate_OTR(df = abcd_data,
...
saveRDS(results_hosp_all150$results, "results_hosp_all150.RData")
saveRDS(results_hosp_all150$CATE_models, "catemodels_hosp_all150.RData")
...
results_hosp_all300 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_all300$results, "results_hosp_all300.RData")
saveRDS(results_hosp_all300$CATE_models, "catemodels_hosp_all300.RData")
...
results_hosp_all450 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_all450$results, "results_hosp_all450.RData")
saveRDS(results_hosp_all450$CATE_models, "catemodels_hosp_all450.RData")
...
results_hosp_all600 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_all600$results, "results_hosp_all600.RData")
saveRDS(results_hosp_all600$CATE_models, "catemodels_hosp_all600.RData")
...
results_hosp_all750 <- estimate_OTR(df = abcd_data,
                                    Y_name = "an_hosp90death",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_hosp_all750$results, "results_hosp_all750.RData")
saveRDS(results_hosp_all750$CATE_models, "catemodels_hosp_all750.RData")
