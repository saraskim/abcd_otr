...
# Treatment effects for the SHIGELLA RULE code for DAY 90 HOSPITALIZATION OR DEATH outcome
#
#
# Sara Kim
# 28 January 2024
...
results_hosp_shig150 <- estimate_OTR(df = abcd_data,
...
saveRDS(results_hosp_shig150$results, "results_hosp_shig150.RData")
saveRDS(results_hosp_shig150$CATE_models, "catemodels_hosp_shig150.RData")
...
results_hosp_shig300 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_shig300$results, "results_hosp_shig300.RData")
saveRDS(results_hosp_shig300$CATE_models, "catemodels_hosp_shig300.RData")
...
results_hosp_shig450 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_shig450$results, "results_hosp_shig450.RData")
saveRDS(results_hosp_shig450$CATE_models, "catemodels_hosp_shig450.RData")
...
results_hosp_shig600 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_shig600$results, "results_hosp_shig600.RData")
saveRDS(results_hosp_shig600$CATE_models, "catemodels_hosp_shig600.RData")
...
results_hosp_shig750 <- estimate_OTR(df = abcd_data,
                                     Y_name = "an_hosp90death",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_hosp_shig750$results, "results_hosp_shig750.RData")
saveRDS(results_hosp_shig750$CATE_models, "catemodels_hosp_shig750.RData")
