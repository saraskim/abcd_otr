...
# Nuisance model code for DAY 90 RE-HOSPITALIZATION or Death outcome
#
#
# Sara Kim
# 28 January 2024
...
# ----- Make sure "0. wrappers.hospdeath.R" script has been run
...
saveRDS(nuisance_output, file="nuisance150_hospdeath_24apr2024.RData")
...
# Save nuisance output
saveRDS(nuisance_output, file="nuisance300_hospdeath_24apr2024.RData")
...
# Save nuisance output
saveRDS(nuisance_output, file="nuisance450_hospdeath_24apr2024.RData")
...
# Save nuisance output
saveRDS(nuisance_output, file="nuisance600_hospdeath_24apr2024.RData")
...
# Save nuisance output
saveRDS(nuisance_output, file="nuisance750_hospdeath_24apr2024.RData")
