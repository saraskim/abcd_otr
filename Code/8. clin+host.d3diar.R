...
# Treatment effects for the symptoms + host (ie. no pathogen) rule code for DAY 3 DIARRHEA outcome
#
#
# Sara Kim
# 28 January 2024
...
results_diar_nop150 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_nop150$results, "results_diar_nop150.RData")
saveRDS(results_diar_nop150$CATE_models, "catemodels_diar_nop150.RData")
...
results_diar_nop300 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_nop300$results, "results_diar_nop300.RData")
saveRDS(results_diar_nop300$CATE_models, "catemodels_diar_nop300.RData")
...
results_diar_nop450 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_nop450$results, "results_diar_nop450.RData")
saveRDS(results_diar_nop450$CATE_models, "catemodels_diar_nop450.RData")
...
results_diar_nop600 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_nop600$results, "results_diar_nop600.RData")
saveRDS(results_diar_nop600$CATE_models, "catemodels_diar_nop600.RData")
...
results_diar_nop750 <- estimate_OTR(df = abcd_data,
                                    Y_name = "day3diar",
                                    A_name = "an_grp_01",
                                    W_list = W_list,
                                    Z_list = Z_lists,
...
saveRDS(results_diar_nop750$results, "results_diar_nop750.RData")
saveRDS(results_diar_nop750$CATE_models, "catemodels_diar_nop750.RData")
