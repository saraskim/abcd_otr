...
# Treatment effects for the PATHOGEN QUANTITIES RULE code for DAY 3 DIARRHEA outcome
#
#
# Sara Kim
# 28 January 2024
...
results_diar_path150 <- estimate_OTR(df = abcd_data,
                                       Y_name = "day3diar",
                                       A_name = "an_grp_01",
                                       W_list = W_list,
                                       Z_list = Z_lists,
...
saveRDS(results_diar_path150$results, "results_diar_path150.RData")
saveRDS(results_diar_path150$CATE_models, "catemodels_diar_path150.RData")
...
results_diar_path300 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_path300$results, "results_diar_path300.RData")
saveRDS(results_diar_path300$CATE_models, "catemodels_diar_path300.RData")
...
results_diar_path450 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_path450$results, "results_diar_path450.RData")
saveRDS(results_diar_path450$CATE_models, "catemodels_diar_path450.RData")
...
results_diar_path600 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_path600$results, "results_diar_path600.RData")
saveRDS(results_diar_path600$CATE_models, "catemodels_diar_path600.RData")
...
results_diar_path750 <- estimate_OTR(df = abcd_data,
                                     Y_name = "day3diar",
                                     A_name = "an_grp_01",
                                     W_list = W_list,
                                     Z_list = Z_lists,
...
saveRDS(results_diar_path750$results, "results_diar_path750.RData")
saveRDS(results_diar_path750$CATE_models, "catemodels_diar_path750.RData")
