# -------------------------------------------------------------------------------------------
# ABCD OTR for change in LAZ
# NUISANCE MODEL
# Code written for HPC
# Sara Kim
# 14 March 2024
# ------------------------------------------------------------------------------------------
...
# Load dataset 
abcd_data <- read.csv("ABCD_OTR_26dec2023.csv")[,-1] 
...
# Run nuisance model 
nuisance_output_750 <- learn_nuisance(df = abcd_data,
                                      Y_name = "lazdiff",
                                      A_name = "an_grp_01",
                                      W_list = W_list,
                                      id_name = "pid", 
...
saveRDS(nuisance_output_750, file="nuisance750_laz_19jun2024.RData")